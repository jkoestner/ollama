...
def setup_logging(name="osllmh"):
    ...
    # osllmh logger
    osllmh_logger = logging.getLogger(name)
    osllmh_logger.setLevel(logging.INFO)

    return osllmh_logger


def set_log_level(new_level, module_prefix="osllmh"):
    """
    Set the log level.
...
def get_log_level(module_prefix="osllmh"):
    """
    Get the log level.
